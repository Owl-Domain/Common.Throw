...
public static partial class GuardExtensions
{
   ...
   /// </exception>
   public static IThrowIfArgument IsEmptyOrWhitespace(this IThrowIfArgument @throw, string value, [CallerArgumentExpression(nameof(value))] string valueArgument = "<value>")
   {
   ...
   /// </exception>
   public static IThrowIfArgument IsNotEmptyOrWhitespace(this IThrowIfArgument @throw, string value, [CallerArgumentExpression(nameof(value))] string valueArgument = "<value>")
   {
