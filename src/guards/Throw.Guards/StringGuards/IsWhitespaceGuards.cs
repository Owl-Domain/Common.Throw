...
public static partial class GuardExtensions
{
   ...
   public static IThrowIf IsWhitespace(this IThrowIf @throw, string value, [CallerArgumentExpression(nameof(value))] string valueArgument = "<value>")
   {
   ...
   /// </exception>
   public static IThrowIf IsNotWhitespace(this IThrowIf @throw, string value, [CallerArgumentExpression(nameof(value))] string valueArgument = "<value>")
   {
