...
{
   #region Methods
   /// <inheritdoc cref="OperationCanceledException.OperationCanceledException()"/>
   ...
   /// <inheritdoc cref="OperationCanceledException.OperationCanceledException(string?)"/>
   /// <exception cref="OperationCanceledException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
   ...
   /// <inheritdoc cref="OperationCanceledException.OperationCanceledException(string?, Exception?)"/>
   /// <exception cref="OperationCanceledException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
   ...
   /// <inheritdoc cref="OperationCanceledException.OperationCanceledException(CancellationToken)"/>
   /// <exception cref="OperationCanceledException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
   ...
   /// <inheritdoc cref="OperationCanceledException.OperationCanceledException(string?, CancellationToken)"/>
   /// <exception cref="OperationCanceledException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
   ...
   /// <inheritdoc cref="OperationCanceledException.OperationCanceledException(string?, Exception?, CancellationToken)"/>
   /// <exception cref="OperationCanceledException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
