...
{
   #region Methods
   /// <inheritdoc cref="ArgumentException.ArgumentException()"/>
   ...
   /// <inheritdoc cref="ArgumentException.ArgumentException(string?)"/>
   /// <exception cref="ArgumentException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
   ...
   /// <inheritdoc cref="ArgumentException.ArgumentException(string?, Exception?)"/>
   /// <exception cref="ArgumentException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
   ...
   /// <inheritdoc cref="ArgumentException.ArgumentException(string?, string?, Exception?)"/>
   /// <exception cref="ArgumentException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
   ...
   /// <inheritdoc cref="ArgumentException.ArgumentException(string?, string?)"/>
   /// <exception cref="ArgumentException"/>
   [DoesNotReturn, StackTraceHidden, MethodImpl(MethodImplOptions.NoInlining)]
